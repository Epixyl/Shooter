...
public class EnemySpawnerController : MonoBehaviour {
	...
	public void SpawnWave(){
		...
		case 1:
			numEnemies = 3;
			SpawnEnemy (0, 100, 10, 1, 1.25, 3, 3, new Vector3(0,-0.2f,0));
			SpawnEnemy (0, 100, 10, 1, 1, 3, 3, new Vector3(0,-0.2f,0));
			SpawnEnemy (0, 100, 10, 1, 1.25, 3, 3, new Vector3(0,-0.2f,0));
			break;
		case 2:
			numEnemies = 3;
			SpawnEnemy (0, 200, 10, 1, 1.25, 3, 3, new Vector3(0,0,0));
			SpawnEnemy (0, 200, 10, 1, 0.5, 3, 3, new Vector3(0,0,0));
			SpawnEnemy (0, 200, 10, 1, 1.25, 3, 3, new Vector3(0,0,0));
			break;
		case 3:
			numEnemies = 3;
			SpawnEnemy (2, 500, 10, 0.5, 0.1, 3, 5, new Vector3(0,0,0));
			SpawnEnemy (0, 300, 10, 1, 0.75, 3, 3, new Vector3(0,0,0));
			SpawnEnemy (0, 300, 10, 1, 0.75, 3, 3, new Vector3(0,0,0));
			break;
		case 4:
			numEnemies = 2;
		...
		case 8:
			...
			SpawnEnemy (0, 300, 10, 1, 1.25, 3, 3, new Vector3(0,0,0));
			SpawnEnemy (0, 300, 10, 1, 0.5, 3, 3, new Vector3(0,0,0));
			SpawnEnemy (0, 300, 10, 1, 1.25, 3, 3, new Vector3(0,0,0));
			break;
		default:
			wave = 1;
